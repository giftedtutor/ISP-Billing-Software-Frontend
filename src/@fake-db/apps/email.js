...
// // GET: Return Emails
// // ------------------------------------------------
// mock.onGet('/ISPBS/apps/email/emails').reply(config => {
...
// // POST: Update Email
// // ------------------------------------------------
// mock.onPost('/ISPBS/apps/email/update-emails').reply(config => {
...
// // ------------------------------------------------
// mock.onPost('/ISPBS/apps/email/update-emails-label').reply(config => {
...
// // ------------------------------------------------
// mock.onGet('/ISPBS/apps/email/get-email').reply(config => {
//   const { id } = config
...
// // ------------------------------------------------
// mock.onGet('/ISPBS/apps/email/paginate-email').reply(config => {
