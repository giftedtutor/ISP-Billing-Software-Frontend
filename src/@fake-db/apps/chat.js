...
// // ------------------------------------------------
// mock.onGet('/ISPBS/apps/chat/chats-and-contacts').reply(() => {
...
// // ------------------------------------------------
// mock.onGet('/ISPBS/apps/chat/users/profile-user').reply(() => [200, data.profileUser])

// // ------------------------------------------------
// // GET: Return Single Chat
// // ------------------------------------------------
// mock.onGet('/ISPBS/apps/chat/get-chat').reply(config => {
...
// // ------------------------------------------------
// mock.onPost('/ISPBS/apps/chat/send-msg').reply(config => {
