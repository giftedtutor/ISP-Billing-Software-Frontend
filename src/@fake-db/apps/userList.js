...
// // GET ALL DATA
// // mock.onGet('http://thesfb.live/ISPBS_Backend/api/getSuppliers').reply(200, data.users)

// // POST: Add new user
// mock.onPost('/ISPBS/apps/users/add-user').reply(config => {
...
// // DELETE: Deletes User
// mock.onDelete('/ISPBS/apps/users/delete').reply(config => {
