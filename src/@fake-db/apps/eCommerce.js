...
// // GET: Return products
// // ------------------------------------------------
// mock.onGet('/ISPBS/apps/ecommerce/products').reply(config => {
...
// // ------------------------------------------------
// mock.onGet('/ISPBS/apps/ecommerce/wishlist').reply(() => {
...
// // ------------------------------------------------
// mock.onGet('/ISPBS/apps/ecommerce/cart').reply(() => {
...
// // ------------------------------------------------
// mock.onPost('/ISPBS/apps/ecommerce/cart').reply(config => {
...
// // ------------------------------------------------
// mock.onPost('/ISPBS/apps/ecommerce/wishlist').reply(config => {
//   // Get product from post data
//   const { productId } = JSON.parse(config.data)
