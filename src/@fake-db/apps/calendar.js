...
// // ------------------------------------------------
// mock.onGet('/ISPBS/apps/calendar/events').reply(config => {
...
// // POST: Add new event
// // ------------------------------------------------
// mock.onPost('/ISPBS/apps/calendar/add-event').reply(config => {
...
// // POST: Update Event
// // ------------------------------------------------
// mock.onPost('/ISPBS/apps/calendar/update-event').reply(config => {
...
// // DELETE: Remove Event
// // ------------------------------------------------
// mock.onDelete('/ISPBS/apps/calendar/remove-event').reply(config => {
