...
// // GET: Return Tasks
// // ------------------------------------------------
// mock.onGet('/ISPBS/apps/todo/tasks').reply(config => {
...
// // POST: Add new task
// // ------------------------------------------------
// mock.onPost('/ISPBS/apps/todo/add-tasks').reply(config => {
...
// // POST: Update Task
// // ------------------------------------------------
// mock.onPost('/ISPBS/apps/todo/update-task').reply(config => {
...
// // DELETE: Remove Task
// // ------------------------------------------------
// mock.onDelete('/ISPBS/apps/todo/delete-task').reply(config => {
