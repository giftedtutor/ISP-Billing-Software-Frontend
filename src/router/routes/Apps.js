...
const AppRoutes = [
  ...
  {
    path: '/ISPBS/apps/getSaleReprot/list',
    component: lazy(() => import('../../views/apps/getSaleReprot/list'))
  },
  {
  ...
  {
    path: '/ISPBS/apps/getMonthlySaleReport/list',
    component: lazy(() => import('../../views/apps/getMonthlySaleReport/list'))
  },
  {
