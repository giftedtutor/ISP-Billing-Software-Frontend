...
import SidebarAdd from './AddSaleModal'
import SidebarEdit from './EditSaleModal'
...
const UsersList = () => {
  ...
  useEffect(() => {
    setLoading(true)
    axios.get(`${baseURL}/stocks/getSales?user_id=${Cookies.get("id")}&&pageNo=${pageNo}&&records=${record}&&status=SALE`)
      .then(response => {
        console.log("Get Sales Data", response)
            ...
            <div>
              ...
              <div className='vertically-centered-modal'>
                ...
                <Modal isOpen={deleteModal} toggle={() => setDeleteModal(!deleteModal)} className='modal-dialog-centered'>
                  ...
                  <ModalBody>
                    Are you sure, you want to delete the selected Sale?
                    <br />
              ...
              <div className='vertically-centered-modal'>
                ...
                <Modal isOpen={centeredModal} toggle={() => setCenteredModal(!centeredModal)} className='modal-dialog-centered'>
                  ...
                  <ModalBody>
                    <Card>
                      <CardImg top src={cnicFrontPic} alt={`${saleName} CNIC Front Side Pic`} />
                    ...
                    <CardImg top src={cnicBackPic} alt={`${saleName} CNIC Back Side Pic`} />
                    <CardBody>
                      <CardText>
                        CNIC Back Side
                      </CardText>
              ...
              <div className='vertically-centered-modal'>
                ...
                <Modal isOpen={centeredModal2} toggle={() => setCenteredModal2(!centeredModal2)} className='modal-dialog-centered'>
                  <ModalHeader toggle={() => setCenteredModal2(!centeredModal2)}>{`Sale Detail`}</ModalHeader>
                  <ModalBody>
                    <Card>
                      <CardBody>
