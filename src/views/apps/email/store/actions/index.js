...
export const getMails = params => {
  return dispatch => {
    return axios.get('/ISPBS/apps/email/emails', { params }).then(res => {
...
export const updateMails = (emailIds, dataToUpdate) => {
  return (dispatch, getState) => {
    return axios.post('/ISPBS/apps/email/update-emails', { emailIds, dataToUpdate }).then(res => {
...
export const updateMailLabel = (emailIds, label) => {
  return (dispatch, getState) => {
    return axios.post('/ISPBS/apps/email/update-emails-label', { emailIds, label }).then(res => {
...
export const paginateMail = (dir, emailId) => {
  return dispatch => {
    return axios.get('/ISPBS/apps/email/paginate-email', { params: { dir, emailId } }).then(res => {
...
export const selectCurrentMail = id => dispatch => {
  return axios.get('/ISPBS/apps/email/get-email', { id }).then(res => {
