          ...
          <div className='email-app-menu'>
            ...
            <PerfectScrollbar className='sidebar-menu-list' options={{ wheelPropagation: false }}>
              ...
              <ListGroup tag='div' className='list-group-labels'>
                <ListGroupItem
                  tag={Link}
                  to='/ISPBS/apps/email/label/personal'
                ...
                <ListGroupItem
                  tag={Link}
                  to='/ISPBS/apps/email/label/company'
                ...
                <ListGroupItem
                  tag={Link}
                  to='/ISPBS/apps/email/label/important'
                ...
                <ListGroupItem
                  tag={Link}
                  to='/ISPBS/apps/email/label/private'
