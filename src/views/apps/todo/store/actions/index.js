...
export const getTasks = params => {
  return dispatch => {
    return axios.get('/ISPBS/apps/todo/tasks', { params }).then(res => {
      dispatch({
        type: 'GET_TASKS',
        tasks: res.data,
        params
...
export const addTask = task => {
  return (dispatch, getState) => {
    axios
      .post('/ISPBS/apps/todo/add-tasks', { task })
      .then(res => {
        dispatch({
          type: 'ADD_TASK',
          task: res.data
...
export const updateTask = task => {
  return (dispatch, getState) => {
    axios
      .post('/ISPBS/apps/todo/update-task', { task })
      .then(res => {
        dispatch({
          type: 'UPDATE_TASK',
          task: res.data
...
export const deleteTask = taskId => {
  return (dispatch, getState) => {
    axios
      .delete('/ISPBS/apps/todo/delete-task', { taskId })
      .then(res => {
        dispatch({
          type: 'DELETE_TASK',
          task: res.data
