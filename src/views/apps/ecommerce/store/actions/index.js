...
export const getProducts = params => {
  return dispatch => {
    return axios.get('/ISPBS/apps/ecommerce/products', { params }).then(res => {
...
export const addToCart = id => {
  return (dispatch, getState) => {
    return axios.post('/ISPBS/apps/ecommerce/cart', { productId: id }).then(res => {
...
export const getWishlistItems = () => {
  return dispatch => {
    return axios.get('/ISPBS/apps/ecommerce/wishlist').then(res => {
...
export const getCartItems = () => {
  return dispatch => {
    return axios.get('/ISPBS/apps/ecommerce/cart').then(res => {
...
export const addToWishlist = id => {
  return dispatch => {
    return axios.post('/ISPBS/apps/ecommerce/wishlist', { productId: id }).then(() => {
